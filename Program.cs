...
{
    sConnection = "Server=DESKTOP-PL42MBE;Database=Tetris;trusted_connection=true";
}
...
builder.Services.AddHttpClient("Tetris", httpClient =>
{
    httpClient.BaseAddress = new Uri("https://localhost:9999/index.html");
    httpClient.DefaultRequestHeaders.Add(
        HeaderNames.UserAgent, "https://localhost:9999/index.html");
});
